...
process.hcalDigis = cms.EDProducer("HcalRawToDigi",
    ...
    firstSample = cms.int32(0),
    lastSample = cms.int32(9),
    saveQIE10DataNSamples = cms.untracked.vint32(10),
    saveQIE10DataTags = cms.untracked.vstring('MYDATA'),
...
process.l1tCaloLayer1Digis = cms.EDProducer("L1TCaloLayer1RawToDigi",
    FEDIDs = cms.vint32(1354, 1356, 1358),
...
process.uct2016EmulatorDigis = cms.EDProducer("L1TCaloSummary",
    ...
    useECALLUT = cms.bool(False),
    useHCALLUT = cms.bool(False),
    useHFLUT = cms.bool(False),
...
process.l1NtupleProducer = cms.EDAnalyzer("BoostedJetStudies",
    activityFraction = cms.double(0.125),
    activityFraction12 = cms.double(0.00390625),
    caloScaleFactor = cms.double(0.5),
    eGammaIsolationFactor = cms.double(0.3),
    eGammaSeed = cms.uint32(5),
    ecalActivityFraction = cms.double(0.25),
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('106X_dataRun2_v10'),
...
process.RawToDigiTask_noTk = cms.Task(process.L1TRawToDigiTask, process.castorDigis, process.ecalDigis, process.ecalPreshowerDigis, process.hcalDigis, process.muonCSCDigis, process.muonDTDigis, process.muonRPCDigis, process.onlineMetaDataDigis, process.scalersRawToDigi, process.tcdsDigis)


process.RawToDigiTask = cms.Task(process.L1TRawToDigiTask, process.castorDigis, process.ecalDigis, process.ecalPreshowerDigis, process.hcalDigis, process.muonCSCDigis, process.muonDTDigis, process.muonRPCDigis, process.onlineMetaDataDigis, process.scalersRawToDigi, process.siPixelDigis, process.siStripDigis, process.tcdsDigis)

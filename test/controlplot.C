...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
	...
	if(recoPt_1 >= 20 && abs(recoEta_1) > 1.474 && abs(recoEta_1) <= 3) { 
	...
	if(recoPt_2 >= 20 && abs(recoEta_1) > 1.474 && abs(recoEta_1) <= 3) { 
...
void controlplot::BookHistos(const char* file2){
	...
	//l1jeteta_1 = new TH1F (name,"l1jeteta_1", binnum, binb);
        ...
        l1jetpt_1 = new TH1F (name,"l1jetpt_1", 40, 20, 200);
	l1jetpt_1->SetTitle("Leading L1 jet");
        ...
        l1jetpt_2 = new TH1F (name,"l1jetpt_2", 40, 20, 200);
        ...
        s2jetpt_2 = new TH1F (name,"s2jetpt_2", 40, 20, 200);
        ...
        reso_pt1 = new TH1F (name,"reso_pt1", 40, -5, 5);
	...
	sprintf(name, "pt_comparison2");
        pt_comparison2 = new TH2F (name,"pt_comparison2", 50, 0, 200, 50, 0, 200);
	pt_comparison2->SetTitle("Sub-leading jets");
        ...
        reso_pt1_s2 = new TH1F (name,"reso_pt1_s2", 40, -5, 5);
        ...
        reso_phi2_s2 = new TH1F (name,"reso_phi2_s2", 40, -0.25, 0.25);
        ...
        pt_comparison1_s2 = new TH2F (name,"pt_comparison1_s2", 50, 0, 200, 50, 0, 200);
        ...
        pt_comparison2_s2 = new TH2F (name,"pt_comparison2_s2", 50, 0, 200, 50, 0, 200);

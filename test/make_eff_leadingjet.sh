# Usage: ./make_eff_leadingjet.sh sample date
sample=$1
date=$2
...
for num in recojetpt_eff_num1 recojetpt_eff_num1_s2; do

if [ ${num} == 'recojetpt_eff_num1' ]; then
	labelprint="Stage-3"
elif [ ${num} == 'recojetpt_eff_num1_s2' ]; then
	labelprint="Stage-2"
fi
...
t2b->SetTextAlign(20);
t2b->Draw("same");
c1->SaveAs("${date}/efficiencies_1_${etarange}_${sample}_${labelprint}.png");
